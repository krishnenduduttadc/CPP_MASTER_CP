...
int main() {
    // Example Input: A set of points (trees)
    ...
    // Call the function to compute the convex hull (outer trees)
    vector<vector<int>> result = outerTrees(trees);
    
    // Output the result
    cout << "The outer trees (convex hull) are: " << endl;
